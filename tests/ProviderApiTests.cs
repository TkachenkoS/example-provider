...
namespace tests
{
    public class ProviderApiTests : IDisposable
    {
        ...
        private string _pactSource = "https://miviewis.pactflow.io/pacts/provider/pactflow-example-provider/consumer/pactflow-example-consumer/version/0.0.2";
        ...
        public void EnsureProviderApiHonoursPactWithConsumer()
        {
            ...
            // This step requires a Pact Broker
            {
                ...
                {
                    if (!String.IsNullOrEmpty("ZRP32zTVVIR083gV58edSA"))
                    {
                        options.TokenAuthentication("ZRP32zTVVIR083gV58edSA");
                    }
